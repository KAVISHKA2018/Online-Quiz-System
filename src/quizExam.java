...
public class quizExam extends javax.swing.JFrame {
    ...
    public void submit(){
        String StudentNo=jLabel11.getText();
        answerCheck();
        try{
           Connection con=ConnectionProvider.getCon();
           Statement st=con.createStatement();
           st.executeUpdate("update student set Marks='"+marks+"'where StudentNo='"+StudentNo+"'");
           String marks1=String.valueOf(marks);
           setVisible(false);
    ...
    public quizExam(String StudentNo) {
        initComponents();
        
        jLabel11.setText(StudentNo);
        ...
        try{
            Connection con=ConnectionProvider.getCon();
            Statement st=con.createStatement();
            ResultSet rs=st.executeQuery("select *from student where StudentNo='"+StudentNo+"'");
    ...
    private void initComponents() {
        ...
        jLabel18.setText("Question Number: ");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 113, -1, 648));

        jLabel20.setFont(new java.awt.Font("Times New Roman", 0, 20)); // NOI18N
        jLabel20.setText("Demo Question?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(367, 138, 810, 160));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 330, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 380, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 490, -1, -1));
